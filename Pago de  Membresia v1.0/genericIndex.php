						...
						<section id="contact">
							<!-- Social -->
								<div class="social column">
									<h3>Información:</h3>
									<p>Inicia sesión para modificar tu galería, agrega o elimina fotos para que puedan ser publicadas.<br>
									   No olvides seguirnos para que podamos promocionar tu trabajo en nuestras redes sociales.</p>
									<h3>Síguenos.</h3>
									<ul class="icons">
							...
							<!-- Form -->
								<div class="column">
									<h3>Inicia sesión.</h3>
									<form action="actionAccess.php" method="post">
